...
int x, y;
    ...
    public formUbahProdukBarang(java.awt.Frame parent, boolean modal) {
        ...
        form_DataProduk nm  = new form_DataProduk();
        loadDataBarang();
        System.out.println(txt_kodeProdukBarang.getText());
    }
    ...
    public void loadDataBarang(){
        form_DataProduk n = new form_DataProduk();
        try {
            String sql = "SELECT * FROM tb_produk WHERE id_produk = '"+txt_kodeProdukBarang.getText()+"'";
            ...
            while (rs.next()) {                
                ...
                txt_satuanProduk.setText(rs.getString("satuan"));
                ...
                System.out.println("HARGA BELI : "+rs.getString("harga_beli"));
                System.out.println("HARGA JUAL : "+rs.getString("harga_jual"));
            }
        } catch (Exception e) {
    ...
    private void btn_batalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_batalMouseClicked
        // TODO add your handling code here:
        form_DataProduk mm = new form_DataProduk();
        mm.loadTableProduk();
        this.dispose();
...
//        Mainhome mn = new Mainhome();
    ...
    public javax.swing.JTextField txt_kodeProdukBarang;
    public javax.swing.JTextField txt_namaProduk;
    public javax.swing.JTextField txt_satuanProduk;
