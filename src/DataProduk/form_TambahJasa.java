 ...
 * @author LenataHoma
 */
public class form_TambahJasa extends javax.swing.JDialog {
int x, y;
Connection con;
     ...
     */
    public form_TambahJasa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DataProduk/form_tambahProdukJasa (1).png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_TambahJasa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                form_TambahJasa dialog = new form_TambahJasa(new javax.swing.JFrame(), true);
